package com.android.ks.tool.callbacks;
...
import com.android.ks.tool.IModuleContext;
...
public abstract class XCallback implements Comparable<XCallback>, IModuleContext {
	...
	public static void callAll(Param param) {
		...
		if (param instanceof XC_LoadPackage.LoadPackageParam) {
			...
			KsConfigGlobal.getHookProvider().deoptMethods(lpp.packageName, lpp.classLoader);
		}
