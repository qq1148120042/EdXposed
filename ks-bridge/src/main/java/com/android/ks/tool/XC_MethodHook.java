...
import com.android.ks.tool.callbacks.IXUnhook;
 ...
 * {@link #beginRunning} and/or {@link #endRunning}.
 */
public abstract class XC_MethodHook extends XCallback {
	 ...
	 *
	 * <p class="note">Note that {@link #endRunning} will be called in reversed order, i.e.
	 * the callback with the highest priority will be called last. This way, the callback has the
	 * final control over the return value. {@link #beginRunning} is called as usual, i.e.
	...
	public void callbeginRunning(MethodHookParam param) throws Throwable {
		beginRunning(param);
	}
	...
	public void callendRunning(MethodHookParam param) throws Throwable {
		endRunning(param);
	}
	...
	public static final class MethodHookParam extends XCallback.Param {
		 ...
		 *
		 * <p>If called from {@link #beginRunning}, it prevents the call to the original method.
		 */
	...
	public class Unhook implements IXUnhook<XC_MethodHook> {
		...
		@Override
		public void unhook() {
			ShadowConnect.unhookMethod(hookMethod, XC_MethodHook.this);
		}
