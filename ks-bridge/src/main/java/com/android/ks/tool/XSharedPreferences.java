...
import com.android.ks.tool.services.FileResult;
...
public final class XSharedPreferences implements SharedPreferences {
    ...
    static {
        try {
            mWatcher = new File(KsInit.prefsBasePath).toPath().getFileSystem().newWatchService();
    ...
    public XSharedPreferences(String packageName, String prefFileName) {
        ...
        Set<String> modules = KsInit.getLoadedModules();
        ...
        if (newModule && KsInit.prefsBasePath != null) {
            mFile = new File(KsInit.prefsBasePath, packageName + "/" + prefFileName + ".xml");
        } else {
