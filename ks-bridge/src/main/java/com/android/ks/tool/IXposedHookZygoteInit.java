 ...
 * in time. Use {@code null} as class loader for {@link ShadowHelpers#findAndHookMethod(String, ClassLoader, String, Object...)}
 * and its variants.
 *
...
public interface IXposedHookZygoteInit extends IXposedMod {
	...
	final class StartupParam extends XCallback.Param {
         ...
         * @hide
         */
        public StartupParam(ShadowConnect.CopyOnWriteSortedSet<? extends XCallback> callbacks) {
            super(callbacks);
        }
