...
public class HookerDexMakerNew implements HookMaker {
    ...
    private void setup(Class mHookClass) {
        ShadowHelpers.setStaticObjectField(mHookClass, FIELD_NAME_METHOD, mMember);
        ShadowHelpers.setStaticObjectField(mHookClass, FIELD_NAME_BACKUP_METHOD, mBackupMethod);
        ShadowHelpers.setStaticObjectField(mHookClass, FIELD_NAME_HOOK_INFO, mHookInfo);
    }
