...
public class HookerDexMaker implements HookMaker {
    ...
    private HookWrapper.HookEntity loadHookerClass(ClassLoader loader, String className) throws Exception {
        ...
        mHookClass.getMethod(METHOD_NAME_SETUP, Member.class, Method.class, ShadowConnect.AdditionalHookInfo.class).invoke(null, mMember, mBackupMethod, mHookInfo);
    ...
    private void generateSetupMethod() {
        ...
        Local<ShadowConnect.AdditionalHookInfo> hookInfo = code.getParameter(2, hookInfoTypeId);
