...
#EDXP_MANAGER="org.ks.tool.manager"
#XP_INSTALLER="com.android.ks.tool.installer"
...
if [[ "$(pm path org.ks.tool.manager 2>&1)" == "" && "$(pm path com.android.ks.tool.installer 2>&1)" == "" ]]; then
    NO_MANAGER=true
fi
