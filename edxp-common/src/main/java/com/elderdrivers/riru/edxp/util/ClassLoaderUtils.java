...
public class ClassLoaderUtils {
        ...
        try {
            ...
            while (parent != null) {
                ...
                if (tmp == null) {
                    ...
                    if (curCL.getParent() == ShadowConnect.dummyClassLoader) {
                        myTopCL = curCL.getParent();
                    }
                    ShadowHelpers.setObjectField(myTopCL, "parent", parent);
                    ShadowHelpers.setObjectField(lastChild, "parent", curCL);
    ...
    public static boolean addPathToClassLoader(ClassLoader classLoader) {
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                ShadowHelpers.callMethod(baseDexClassLoader, "addDexPath", DEXPATH);
            } else {
    ...
    public static void hookClassLoading() {
        ...
        ShadowHelpers.findAndHookMethod(Class.class,
        ...
        XC_MethodHook findClassHook = new XC_MethodHook(Integer.MAX_VALUE) {
            ...
            protected void beginRunning(MethodHookParam param) throws Throwable {
                ...
                try {
                    param.setResult(ShadowHelpers.callMethod(currentCl,
        ...
        ShadowHelpers.findAndHookMethod(BaseDexClassLoader.class,
                "findClass", String.class, findClassHook);
        ShadowHelpers.findAndHookMethod("java.lang.BootClassLoader", null,
                "findClass", String.class, findClassHook);
    }
}
