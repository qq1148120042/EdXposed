...
public class HookerDexMaker {
    ...
    private static final String CALLBACK_METHOD_NAME_BEFORE = "callbeginRunning";
    private static final String CALLBACK_METHOD_NAME_AFTER = "callendRunning";
    ...
    private static final TypeId<ShadowConnect.AdditionalHookInfo> hookInfoTypeId
            = TypeId.get(ShadowConnect.AdditionalHookInfo.class);
    private static final TypeId<ShadowConnect.CopyOnWriteSortedSet> callbacksTypeId
            = TypeId.get(ShadowConnect.CopyOnWriteSortedSet.class);
    ...
    private static final TypeId<ShadowConnect> xposedBridgeTypeId = TypeId.get(ShadowConnect.class);
    private static final MethodId<ShadowConnect, Void> logThrowableMethodId =
            xposedBridgeTypeId.getMethod(TypeId.VOID, "log", throwableTypeId);
    private static final MethodId<ShadowConnect, Void> logStrMethodId =
            xposedBridgeTypeId.getMethod(TypeId.VOID, "log", TypeId.STRING);

    private static AtomicLong sClassNameSuffix = new AtomicLong(1);

    private FieldId<?, ShadowConnect.AdditionalHookInfo> mHookInfoFieldId;
    ...
    private ShadowConnect.AdditionalHookInfo mHookInfo;
    ...
    public void start(Member member, ShadowConnect.AdditionalHookInfo hookInfo,
    ...
    private void doMake(String hookedClassName) throws Exception {
        ...
        mHookClass.getMethod(METHOD_NAME_SETUP, Member.class, ShadowConnect.AdditionalHookInfo.class)
    ...
    private void generateSetupMethod() {
        ...
        Local<ShadowConnect.AdditionalHookInfo> hookInfo = code.getParameter(1, hookInfoTypeId);
    ...
    private void generateHookMethod() {
        ...
        Local<ShadowConnect.AdditionalHookInfo> hookInfo = code.newLocal(hookInfoTypeId);
        Local<ShadowConnect.CopyOnWriteSortedSet> callbacks = code.newLocal(callbacksTypeId);
        ...
        FieldId<ShadowConnect, Boolean> disableHooksField =
        ...
        // because args[] may be changed in beginRunning
